		...
		<div class="container">
			...
			<div id="new_nav">
				...
				<div id="t_nav">
					...
					<a href="/events"<?php if(is_page(3116)) { echo ' class="nav_on"'; } ?>>Events</a><span>|</span><a href="/our-clients"<?php if(is_page(2251)) { echo ' class="nav_on"'; } ?>>Clients</a><span>|</span><a href="/resource-page"<?php if(is_page(2242)) { echo ' class="nav_on"'; } ?>>Resources</a><span>|</span><a href="/contact"<?php if(is_page(38)) { echo ' class="nav_on"'; } ?>>Contact</a>
				
				</div><!--end #t_nav-->
			
				<ul id="main_nav">
				
					<li<?php if(is_tree(6)) { echo ' class="nav_on"'; } ?>><a href="/programs">Programs</a></li>
